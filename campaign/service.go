...
type Service interface {
	...
	SaveCampaignImage(input CreateCampaignImageInput, fileLocaiton string) (CampaignImage, error)
}
...
func (s *service) SaveCampaignImage(input CreateCampaignImageInput, fileLocaiton string) (CampaignImage, error){
	...
	campaignImage.FileName = fileLocaiton
